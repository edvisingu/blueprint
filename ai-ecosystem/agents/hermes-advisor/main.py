# hermes-advisor — EdVisingU specialist agent (Masterbuild §31.3 pattern).
...
from tools.notion_tools import create_notion_page, append_to_database  # noqa: E402
from tools.search import web_search  # noqa: E402

TOOLS = {
    "web_search": web_search,
    "create_notion_page": create_notion_page,
    "append_to_database": append_to_database,
}
