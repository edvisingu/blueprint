# hermes-finance — EdVisingU specialist agent (Masterbuild §31.3 pattern).
...
from tools.code_exec import run_python_code  # noqa: E402
from tools.file_tools import create_file  # noqa: E402
from tools.stripe_tools import get_mrr, get_recent_revenue  # noqa: E402

TOOLS = {
    "get_mrr": get_mrr,
    "get_recent_revenue": get_recent_revenue,
