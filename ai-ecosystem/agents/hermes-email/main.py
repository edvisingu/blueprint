# hermes-email — EdVisingU specialist agent (Masterbuild §31.3 pattern).
...
from tools.n8n_tools import trigger_email_send  # noqa: E402
from tools.notion_tools import create_notion_page  # noqa: E402
